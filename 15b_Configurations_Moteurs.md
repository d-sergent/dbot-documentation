# 15b — Analyse Biomécanique : Configurations Moteurs & Évolutions

> **Série Biomécanique :**
> - [15a] [Locomotion Baseline](./15a_Analyse_Locomotion_Baseline.md)
> - [15b] **Configurations Moteurs & Évolutions** ← *vous êtes ici*
...
Ce document présente les différentes configurations moteur étudiées (Options A/B/C/D), les propositions d'évolution, l'analyse du DOF Roll manquant à la cheville, et les améliorations de stabilité (capteurs FSR, algorithmes).
