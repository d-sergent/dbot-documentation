...
1.  **[Synthèse du Projet](FINAL_Synthese_Projet.md)** : Vision, Roadmaps et Architecture CPU/IA.
2.  **[Liste des Achats (BOM)](../05_Gestion_Projet/FINAL_Liste_Achats_BOM.md)** : Composants exacts et liens marchands.
3.  **[Guide Montage Mécanique](../01_Mecanique_et_Chassis/FINAL_Guide_Montage_General.md)** : Tolérances, roulements et CNC.
4.  **[Électronique & Câblage](../02_Electronique_et_Energie/STUDY_Electronique_Historique.md)** : Bus CAN, Star Power 48V et PDB.
5.  **[Logiciel & Configuration](../03_Intelligence_et_Logiciel/FINAL_Config_OS_Jetson.md)** : JetPack, ROS2, mROS.
7.  **[Vision et IA](../04_Perception_et_Sensors/FINAL_Pipeline_Vision.md)** : OAK-D Pro S2 FF et LiDAR Unitree L2 (V2).
8.  **[Architecture Audio](../04_Perception_et_Sensors/FINAL_Architecture_Audio.md)** : XMOS XVF-3800 et Haut-Parleur.
9.  **[Intelligence Conversationnelle](../03_Intelligence_et_Logiciel/STUDY_LLM_Conversationnel.md)** : Intégration LLM local 100% hors-ligne, STT, TTS et debug mémoire.
10. **[Stratégie IMU et Fusion](../04_Perception_et_Sensors/STUDY_IMU_Fusion.md)** : Équilibre Bipède (416Hz) et V-SLAM.
...
14. **[Cinématique & Moteurs](../01_Mecanique_et_Chassis/STUDY_Cinematique_Moteurs.md)** : Tableau comparatif RobStride.
...
- **[Étude Cheville Cardan](../01_Mecanique_et_Chassis/Jambes_et_Pieds/STUDY_Cheville_Cardan.md)**
