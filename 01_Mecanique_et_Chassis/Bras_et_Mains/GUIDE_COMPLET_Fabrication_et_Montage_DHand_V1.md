...
2.  **Bridage distal sans nœud :** À une extrémité du câble, insérez un manchon (sleeve) en aluminium ou en cuivre de Ø1.5 mm. Repliez le câble en créant une micro-boucle (épissure Brummel si possible) et **sertissez le manchon de manière ferme** à l'aide d'une pince à sertir technique.
    *   ⚠️ **Contrainte Magnétique Critique (Pas d'interférence capteur) :** Utilisez exclusivement des manchons en **Aluminium** ou en **Cuivre** (amagnétiques, perméabilité $\mu_r \approx 1$). N'utilisez jamais de manchons en acier ou en acier inoxydable qui perturberaient gravement le champ magnétique de l'aimant mesuré par le capteur MLX90393.
    *   🛠️ **Modélisation CAO (Fusion 360) :** Pour éviter que le manchon (long de 4.0 à 5.0 mm) ne dépasse ou ne fasse une bosse sous la chaussette en TPU, prévoyez un logement cylindrique de **Ø 2.8 mm et de 5.5 mm de profondeur** (lamage) dans la phalange distale en PA12-CF à la sortie du canal. Le manchon s'y insère et y reste entièrement noyé (flush) dans le squelette rigide.
    *   💡 **Astuce de Sourcing (Pêche Sportive) :** Pour trouver facilement et à très bas coût ces manchons et la pince en France, recherchez du matériel de gréement de pêche aux carnassiers :
        *   **Les manchons :** Vendus sous le nom de **"Sleeves de pêche"** de **1.2 mm ou 1.5 mm** (cuivre ou laiton). Disponibles par paquets de 50 pour moins de 4 € chez Decathlon, Pecheur.com ou Amazon.fr.
...
3.  *Alternative pour prototype :* Si vous utilisez des nœuds, réalisez un **Nœud Ashley Stopper** serré à la pince à bec plat. Notez qu'avec le Dyneema DM20 de 1.0 mm, le nœud mesurera 3.5 à 4.0 mm de diamètre (il faudra élargir la cavité CAO correspondante). Laissez une queue de sécurité de 5 mm et déposez une micro-goutte de **Loctite Super Glue Gel** sur le nœud et sur la queue de fil pour figer les fibres extrêmement glissantes du Dyneema et éviter tout glissement.
