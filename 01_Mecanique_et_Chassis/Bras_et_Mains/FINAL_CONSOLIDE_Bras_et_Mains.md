...
*   **Maturité :** La conception est finalisée, documentée et thermiquement/mécaniquement verrouillée (★★★★★). L'ensemble des risques critiques identifiés lors des audits précédents (grip, rupture câble, buck thermique) sont définitivement résolus par l'adoption de l'architecture Hybrid Premium.
...
*   **Main D-Hand Hybrid Premium :** Combinaison de **5 servomoteurs Feetech STS3250** (flexion en force) et **3 servomoteurs Feetech HL-3915** (axes de précision avec mode force matérielle) pour un grip effectif réel de **376 N** et 8 DOF complets. L'actionnement est déporté dans l'avant-bras via des tendons Dyneema.
...
| **Coude Pitch** | `elbow_pitch` | revolute | 0 1 0 (Y) | RobStride RS-06 | 12 N·m | 36 N·m | 621 g | CAN (1 Mbps) |
...
| **Main (8 DOF)** | `finger_joint_*` | under-act | - | 5x STS3250 + 3x HL-3915 | 1.9 N·m (HL) / 3.0 N·m (STS) | 2.6 N·m / 4.9 N·m | 480 g (total) | TTL (SCServo) |

**Répartition des 8 DOF de la main (D-Hand Hybrid Premium) :**

| # | Doigt | Mouvement | Servo Affecté | Type Moteur | Tendon |
| :-: | :---- | :-------- | :------------ | :---------- | :----- |
| 1 | Pouce | Flexion (Curl) | **STS3250** (ID 1) | Coreless (4.9 N·m pic) | Dyneema Ø0.80mm |
| 2 | Pouce | Opposition (Abd.) | **HL-3915** (ID 6) | Coreless (Mode Force Matérielle) | Dyneema Ø0.60mm |
| 3 | Index | Flexion (Curl) | **STS3250** (ID 2) | Coreless (4.9 N·m pic) | Dyneema Ø0.80mm |
| 4 | Index | Abduction | **HL-3915** (ID 7) | Coreless (Mode Force Matérielle) | Dyneema Ø0.60mm |
| 5 | Majeur | Flexion (Curl) | **STS3250** (ID 3) | Coreless (4.9 N·m pic) | Dyneema Ø0.80mm |
| 6 | Annulaire | Flexion | **STS3250** (ID 4) | Coreless (4.9 N·m pic) | Dyneema Ø0.80mm |
| 7 | Auriculaire | Flexion | **STS3250** (ID 5) | Coreless (4.9 N·m pic) | Dyneema Ø0.80mm |
| 8 | Paume | Curl palmaire | **HL-3915** (ID 8) | Coreless (Mode Force Matérielle) | Dyneema Ø0.60mm |

---

## 2. Structure des Membres Supérieurs
...
*   **Tendon de Force (Flexion ×5) :** Tresse Dyneema Ø0.80 mm (résistance à la rupture élevée ~1177 N).
*   **Tendon de Précision (×3) :** Tresse Vectran ou Dyneema Ø0.60 mm (résistance à la rupture ~750 N).
...
*   **Poulie d'enroulement (Spool) :** Ø14 mm en Aluminium 7075-T6 usinée CNC (NestWorks C500).
    *   **Rayon effectif au fond de gorge :** r = 6 mm.
...
*   **Retour passif des doigts :** Peau en silicone (EcoFlex 00-30 ou Dragon Skin 10) moulée sur les phalanges assurant le rappel élastique. **Aucun ressort ni tendon d'extension métallique n'est requis en configuration V1.x.**

---

### 2.4 Convertisseur et Gestion Thermique

*   **Convertisseur de puissance :** **Pololu D24V150F12** synchrone à haute efficacité (95%).
    *   **Puissance électrique maximale :** ~109 W en stall (12V, 9.1A maximum en blocage simultané).
    *   **Dissipation thermique réelle :** Réduite à **~3.4 W à 5.7 W** (efficacités de 95% à 97%), éliminant le risque de surchauffe à l'intérieur du tube confiné.
*   **Mitigation thermique :** Le PCB du convertisseur est monté en contact thermique direct avec la plaque interne en aluminium de l'avant-bras via un **Gap Pad Bergquist 5000S35 (0.5 mm)**. Le tube carbone/alu agit comme un radiateur passif géant, maintenant les composants sous 50°C.

---

### 2.5 Performances Validées

*   **Force de Grip (Power Grasp cylindrique, nominal continu) :** **376 N** (avec rendement réaliste global $\eta_{total} = 0.83$ validant la friction Dyneema/PTFE et les pivots de phalanges).
    *   **Tension Dyneema STS3250 (continu) :** ~415 N.
    *   **Force à la pulpe par doigt (continu) :** **83 N** (avec rendement $\eta=0.83$).
*   **Force de Pince Pouce-Index (Pinch Grasp) :** **~83 N**.
*   **Vitesse de fermeture :** ~0.5 s.
*   **Facteur de Sécurité du câble Dyneema Ø0.80mm (rupture 1177 N) :**
    *   Traction crête en pic (STS3250 à 4.9 N.m) = 581 N (à r=7mm avec rendement $\eta=0.83$).
    *   Fs = 1059 N (rupture effective sertie à 90%) / 581 N = **1.82** (Hautement sécurisé pour des charges répétées >5 kg).
...
| Dyneema tressé Ø0.80mm (bobine 50m) | 1 | Berkley | ~15 € | ~15 € |
...
| **TOTAL Matériaux & Quincaillerie (par bras)** | | | | **~225 €** |

### 3.3 Coût Total Estimé (par bras)

*   **Total Moteurs & Électronique :** ~2000 €
*   **Total Matériaux & Quincaillerie :** ~225 €
*   **TOTAL GÉNÉRAL ESTIMÉ PAR BRAS : ~2225 €** (Économie de **~1100 €** sur le robot complet par rapport au design Dynamixel initial).
...
2.  **Dissipation thermique sous cycle de grip intensif :** Valider expérimentalement la température du convertisseur Pololu D24V150F12 lors d'une phase de blocage prolongé (stall de grip) sous 50°C par conduction thermique dans l'avant-bras.
3.  **Validation expérimentale AnySkin (V2) :** Préparer le pipeline de transition logicielle des capteurs FSR 402 vers la peau magnétique AnySkin pour au-delà de la manipulation fine sans recalibrage.
4.  **Test d'usinage de spools en Bronze CuSn8 :** Réaliser un essai d'usinage sur la C500 avec du bronze CuSn8 pour évaluer le gain de glissement et de durabilité de la gorge par rapport à l'Aluminium 7075-T6.
...
---
**Fin du document consolidé – Version V1.x (Mai 2026).**