...
> **Source de vérité CAO** : `Torse v96`  
> **Date de l'audit** : 2026-09-23T22:22:23.821539  
...
* **Masse totale de l'ensemble Torse + Bassin** : **16.72 kg** (16718.0 g).
...
* **Centre de gravité global (CoM)** :
  ...
  * **Z** (hauteur) = **1145.62 mm** (situé au niveau du plexus, entre le waist à 1035 mm et la plaque de cou à 1476 mm).
...
| **Traverse Renfort Bassin** | 1010.39 | 1020.41 | 10,02 | Appui châssis : 0.03 mm | **Contact franc** |
| ↳ *Lamage Traverse (profondeur 3,00 mm)* | — | **1017.41** | Prof. 3,00 | — | Face d'appui du RB8016 |
| **Roulement RB8016** | **1017.40** | **1033.44** | 16,04 | Fond lamage : **0.01 mm** | **Contact franc parfait (10 µm)** |
| **Waist Plate 7075** | **1033.41** | **1042.44** | 9,03 | Appui bague int. : 0.03 mm | **Contact franc** |
