...
|---------|-----------|-----------------|---------------|
| `15c_Revision_Cardan_39kg.md` | Titre + multiple | "39 kg" / "~39 kg" | "40.2 kg" |
| `15c_Revision_Cardan_39kg.md` | 10, 16, 22, 38, 49, 74, 99, 156, 175, 191, 194 | "39 kg" / "~39 kg" | "40.2 kg" |
...
| `15_Analyse_Biomecanique.md` | 13, 27 | "Révision Cardan 39 kg" | "Révision Cardan 40.2 kg" |
| `03_Montage_Mecanique.md` | 106, 117, 142 | "39 kg" | "40.2 kg" |
| `15d_Genou_et_Course.md` | 35, 322 | "39 kg" | "40.2 kg" |
| `15f_Portage_Charges_et_Marche.md` | 5-6 | Références "39 kg" | "40.2 kg" |
| `23_Strategie_Ultralight_Sous_Genou.md` | 64 | "39 kg" | "40.2 kg" |
...
**Note**: Le fichier `15c_Revision_Cardan_39kg.md` devrait être renommé `15c_Revision_Cardan_40_2kg.md` pour refléter la masse réelle.
...
| Fichier | Ligne(s) | Valeur actuelle | Valeur cible |
|---------|-----------|-----------------|---------------|
| `14_Cinematique_Moteurs.md` | 53, 67, 148, 175 | "24" moteurs | "26" moteurs |
| `04_Electronique_Cablage.md` | 298 | "24 moteurs" | "26 moteurs" |
| `05_Logiciel_Configuration.md` | 71 | "24 moteurs" | "26 moteurs" |
| `16_Conclusions_Architecture_DBot.md` | 243 | "TOTAL MOTEURS (24)" | "TOTAL MOTEURS (26)" |
...
| Fichier | Ligne(s) | Valeur actuelle | Valeur cible |
|---------|-----------|-----------------|---------------|
| `Synthese_Etat_Actuel/SYNTHESE_Electronique.md` | 16 | "48V → 5V" | "48V → 19V" |
...
| Fichier | Ligne(s) | Valeur actuelle | Valeur cible |
|---------|-----------|-----------------|---------------|
| `04_Electronique_Cablage.md` | 26 | "Tous les moteurs... chaînés en série (daisy-chain)" | Ajouter exception pour RS-05 (single-port) |
...
| Fichier | Ligne(s) | Valeur actuelle | Valeur cible |
|---------|-----------|-----------------|---------------|
| `04_Electronique_Cablage.md` | 26 | "Le dernier moteur doit porter une résistance de terminaison 120 Ω" | Ajouter exception bus cou (<30cm) |
...
| `annexes/vision/51_Installation_OAK_D_DepthAI.md` | 11 | "L'OAK-D Pro n'est pas..." | Ajouter "(Fixed Focus)" |
| `02_Liste_Achats.md` | 100 | "OAK-D Pro FF" | ✅ DÉJÀ CORRECT |
| `00_Index.md` | 26 | "OAK-D Pro S2 FF" | ✅ DÉJÀ CORRECT (S2 mentionné) |
| `28_Dimensions_Physiques_Synthese.md` | 43 | "OAK-D Pro (Vision)" | Ajouter "(Fixed Focus)" |
| `06_Decisions_Architecturales.md` | 28 | "OAK-D Pro (vision stéréo)" | Ajouter "(Fixed Focus)" |
| `19_Perception_Spatiale_LiDAR.md` | 99, 120, 197 | "OAK-D Pro" | Ajouter "(FF)" à chaque mention |
...
| Fichier | Ligne(s) | Valeur actuelle | Valeur cible |
|---------|-----------|-----------------|---------------|
| `09_Intelligence_Conversationnelle.md` | 29 | "port **USB-C** de la Jetson" | "port **USB-A (bleu)**" |
| `08_Architecture_Audio.md` | 154 | `--channels=1` (mono) | Documenter 6 canaux (4 micros + 2 référence) |
| `Synthese_Etat_Actuel/SYNTHESE_Audio_IMU.md` | 12 | "4 micros MEMS" | "4 micros MEMS, 6 canaux (incl. référence AEC + bruit moteurs)" |
...
|---------|----------|-----------------|
| `14_Cinematique_Moteurs.md` | § "Analyse Thermique Statique" (l.124-126) | Couple requis pour 40.2 kg vs 39 kg |
| `14_Cinematique_Moteurs.md` | § "Marge Statique Cheville" | 40.2 kg → recalcul couple statique |
| `15c_Revision_Cardan_39kg.md` | § 11.7 "Synthèse de la Validité" | Tous les calculs de couple avec 39 kg → 40.2 kg |
| `15c_Revision_Cardan_39kg.md` | § 4 "Performances & Limites" | Couple statique: 38.3 N.m (39 kg) → ~39.5 N.m (40.2 kg) |
| `15d_Genou_et_Course.md` | § "Couple Genou" | τ_genou_course = 172 N.m (39 kg) → ~177 N.m (40.2 kg) |
| `16_Conclusions_Architecture_DBot.md` | § "Cheville" | Couple statique et marges avec 40.2 kg |
| `Synthese_Etat_Actuel/SYNTHESE_Cheville.md` | § 4 "Performances" | Marge statique: 38.3 N.m → 39.5 N.m |
| `23_Strategie_Ultralight_Sous_Genou.md` | § "Résistance au cisaillement" | Robot de 39 kg → 40.2 kg (impact mineur) |
...
| Fichier | Section | Calcul à revoir |
|---------|----------|-----------------|
| `04_Electronique_Cablage.md` | § "Bras G/D" | Courant Jetson: 19V × X W / 48V = nouveau courant |
| `Synthese_Etat_Actuel/SYNTHESE_Electronique.md` | § "Régulation" | Confirmer DC-DC 48V→19V 5A (95W) suffisant |
...
5. **MOYENNE**: `15c_Revision_Cardan_39kg.md` (renommer + mettre à jour)
6. **BASSE**: Fichiers annexes (OAK-D, Audio)
...
1. **Renommage de fichier**: `15c_Revision_Cardan_39kg.md` → `15c_Revision_Cardan_40_2kg.md` (mettre à jour tous les liens)
2. **Cohérence des liens**: Après renommage, vérifier tous les fichiers pointant vers l'ancien nom
3. **Tests de validation**: Après corrections, relancer `check_integrity.py` pour valider la cohérence
4. **Sauvegarde**: Créer un tag git avant corrections majeures
