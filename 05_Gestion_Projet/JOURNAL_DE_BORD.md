...
2. **Caractérisation de la Liaison Tube-Bride 100% Mécanique (Zéro Colle Époxy)** :
   ...
   - **Spécification de la Boulonnerie (Tirants M5 & Pincement Radial M4) & Perçage CNC** : Vis CHC M5 × 60 mm (ISO 4762 classe 8.8 / 10.9) pour empilement 49.0–51.0 mm (saillie bague nylon +2.4 mm), vis CHC M4 × 18 mm (ou M4 × 20 mm) pour pincement radial sur bloc de 11.0 mm de largeur (trous traversants **Ø 4.3 mm ISO 273 Moyen**, chanfreins 0.5 mm × 45°), rondelles DIN 125A (M4/M5), écrous Nylstop DIN 985 (M4/M5), trou tirant **Ø 5.5 mm (ISO 273 Moyen)**. Règle CAO critique : fente de pincement fixée à **1.0 mm net (±0.1 mm)** pour interdire la butée prématurée alu-alu d'une fente à 0.1 mm. Intégration du tutoriel d'importation directe 3D STEP M4/M5 via l'outil McMaster-Carr de Fusion 360.
