...
- [x] **Acquisition Massive Motorisation RobStride (23/27 moteurs acquis — 85,2 %)** : Commande additionnelle de 9× RS-03 et 4× RS-04. Phase 4 (Jambes — 12 DOF) motorisée à 100% (4× RS-04 pour hanches/genoux + 8× RS-03 pour hanches/chevilles). Épaules et coudes (Phases 2 & 3) motorisés à 100% (2× RS-04 + 4× RS-03). Seuls 4 moteurs RobStride restent à acquérir sur l'intégralité du robot (1× RS-02 épaule yaw bras 2, 1× RS-00 poignet pitch bras 2, 2× supinations avant-bras RS-10P ou RS-02).
...
- [x] **Traverse / Platine Waist (`Traverse_Renfort_Bassin`)** : Usinage in-situ validé sous Fusion 360 (`Torse v97` & Option 1) : épaisseur totale 12,51 mm (Z = 1007,90 à 1020,41 mm), bossage inférieur descendant de 2,49 mm avec contact franc métal-métal à 0,00 mm (Angle 0,00 deg) sur stator RS-06 à Z = 1007,90 mm, lamage siège roulement Ø 120,00 mm H7 (prof. 3,0 mm, RB8016 calé), alésage central dégagé Ø 74,56 mm (jeu radial 11,28 mm), fixation directe du stator par 8 vis CHC M3 × 12 mm Tête Basse DIN 7984 (McMaster `92855A313`) sur PCD Ø 82,0 mm avec lamages Ø 6,0 mm sur plan d'assise Z = 1010,93 mm (entrefer axial franc de 1,48 mm sous le moyeu tournant, zéro frottement) et fixation au pelvis sur 4 vis d'angles FHC M5 affleurantes à 0,0 mm.
- [x] **Brides Étagées en L Retenue Axiale RB8016 (Option A Validée)** : Implantation des 4 taraudages borgnes M4 dans les 4 coins à 45° sur PCD nominal **`Ø 136,00 mm`** sur `Traverse_Renfort_Bassin` + 4 fraisures coniques 90° Ø 10,40 mm × 3,10 mm pour vis d'angles FHC M5 × 25 mm affleurantes à **0,0 mm** (pont de matière plein de 1,47 mm face aux talons des brides). Modélisation et script Fusion 360 `ModeliserBrideRB8016.py` créés, composant STEP `Bride_Retenue_RB8016_L` (16 × 15 × 15 mm, bec 2 mm, vis CHC M4 × 16 mm McMaster `92290A154` et rondelles DIN 125A `93475A230`) inséré avec contrainte `Rigid Joint` et répétition circulaire 4×. Redan inférieur de `Waist_Plate_7075` ajusté à 3,0 mm pour ménager un entrefer franc de 1,0 mm sans frottement.
...
- [x] **Contrôle Final Global & Quincaillerie Complète Torse (Torse v94)** : 306 composants modélisés (16,71 kg torse + bassin). Intégration complète de la quincaillerie structurelle : 4× CHC M4×16 (cou 30×50 mm), 4× FHC M3×8 (moteur RS-05), 6× CHC M4×20 (pincements colonne), 4× CHC M4×20 (sandwich waist), 20× rondelles DIN 125A M4, 14× écrous Nylstop M4 et 4× goupilles rectifiées ISO 8734 Ø 3×14 mm. Standardisation 100% conforme via `RenameFastenersTorse.py`.
