...
- [x] **Dossier Technique Mécanique Torse V2.6 & Équerres Optimisées** : Validation complète du torse (colonne 7075-T6 5 mm, inserts traversants Ø 35 mm Option B, équerres cou 30×30×3 mm Option C sans taraudage ni oblong, rectangle 30×45 mm libérant un corridor central de 45 mm pour le moteur cou RS-05, protocole de montage inversé naturel, devis Blockenstock & visserie France Bricovis) dans [DOSSIER_TECHNIQUE_Torse_Complet_D-Bot_V2.md](file:///Users/Shared/Mon%20Google%20Drive%20Physique/Documentation/01_Mecanique_et_Chassis/Torse/DOSSIER_TECHNIQUE_Torse_Complet_D-Bot_V2.md).
