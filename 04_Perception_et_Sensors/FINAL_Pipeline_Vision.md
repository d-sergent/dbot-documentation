...
- **Rôle dans la stratégie IMU** : Voir [18 — Stratégie IMU](STUDY_IMU_Fusion.md) pour la répartition des rôles (IMU tête vs IMU torse vs IMU LiDAR).
...
> 👉 Pour l'étude technique complète du LiDAR, son montage sur le torse et la stratégie de fusion : **[19 — Perception Spatiale & LiDAR](STUDY_LiDAR_Slam.md)**.
