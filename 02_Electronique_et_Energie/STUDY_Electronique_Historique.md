...
*   Intègre une **IMU (BNO085/BMI270)** — **utilisée uniquement pour la stabilisation du regard**, pas pour l'équilibre du corps (voir [18 — Stratégie IMU](../04_Perception_et_Sensors/STUDY_IMU_Fusion.md)).
...
> [!WARNING]
> **3 bornes Wanptek : (+), (-) et (⏚ GND).** Brancher les moteurs et le module de debug sur la borne **(-)** uniquement. La borne **(⏚ GND)** est la terre de protection secteur (PE) — ne rien brancher dessus. Voir [Doc 04 §4b](STUDY_Electronique_Historique.md#4b-c%C3%A2bles-de-puissance-moteurs--guide-dachat-et-longueurs) pour le détail.
...
*   **Sécurité** :
    ...
    *   MOSFET piloté par Spresense pour coupure logicielle (voir [Guide Watchdog](STUDY_Watchdog_Robot.md)).
...
### 7.1 Niveau 1 : Détection Réflexe (Spresense)
...
### 7.2 Niveau 2 : Confirmation Cognitive (Jetson & OAK-D)
...
### 7.3 Niveau 3 : Réflexe de Survie (Watchdog)
